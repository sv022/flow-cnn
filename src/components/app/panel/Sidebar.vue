...
<template>
  <aside :class="cn('fixed top-0 left-0 z-20 h-screen -translate-x-full lg:translate-x-0 transition-[width] ease-in-out duration-300', isOpen ? 'w-72' : 'w-22.5')">
    ...
    <div class="relative h-full flex flex-col px-3 py-4 overflow-y-auto shadow-md dark:shadow-zinc-800">
      <Button variant="ghost" class="hover:bg-transparent" as-child>
        <RouterLink to="/">
          <FlowCnnLogo />
        </RouterLink>
      </Button>
