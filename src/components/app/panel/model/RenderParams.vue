...
<template>
  <div class="flex flex-col space-y-6 py-4">
    <span class="flex items-center space-x-4">
      <Label class="text-charcoal text-nowrap" for="feature-scale">Feature scale</Label>
      <Slider id="feature-scale" v-model="featureScale" :min="1" :max="10" :step="0.1" @update:model-value="updateRenderParams" />
    </span>
    <span class="flex space-x-4">
      <Label class="text-charcoal text-nowrap">Feature spacing</Label>
    ...
    <span class="flex space-x-4 mt-2">
      <Label class="text-charcoal text-nowrap">Show layer labels</Label>
