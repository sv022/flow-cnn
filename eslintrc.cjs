...
module.exports = {
  ...
  plugins: ["markdown", "vue", "fp", "unicorn", "@typescript-eslint"],
  extends: [
    "eslint:recommended",
    "standard",
    "prettier",
  ...
  rules: {
    ...
    "max-len": ["warn", { code: 200, ignoreComments: true, ignoreStrings: true, ignoreTemplateLiterals: true, ignoreRegExpLiterals: true }],
    "arrow-body-style": 2,
    "block-scoped-var": 2,
    ...
    "max-lines-per-function": [2, { max: 175, skipBlankLines: true, skipComments: true, IIFEs: true }],
    ...
    "no-param-reassign": [
      ...
      {
        props: true,
        ignorePropertyModificationsFor: ["error", "errorA", "req", "request", "res", "response", "state", "runState", "logs", "logsArray", "currentEnv", "t"],
      },
    ],
    ...
    "eslint-comments/no-use": [2, { allow: ["eslint-disable-next-line", "eslint-disable", "eslint-enable", "eslint-env"] }],
